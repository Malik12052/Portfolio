...
const LinksOverlay = () => {
  return (
    <nav className="fixed right-4 top-4 z-50 h-[calc(100vh_-_32px)] w-[calc(100%_-_32px)] overflow-hidden">
      <Logo />
      <LinksContainer />
      <FooterCTAs />
    </nav>
  ...
  return (
    <>
      <motion.div
        ...
        className="fixed z-50 rounded-xl bg-gradient-to-br from-violet-600 to-violet-500 shadow-lg shadow-violet-800/20"
      />
